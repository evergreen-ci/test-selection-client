...
type ApiExplainPatchApiTestSelectionExplainPatchPatchIdPostRequest struct {
	ctx context.Context
...
func (r ApiExplainPatchApiTestSelectionExplainPatchPatchIdPostRequest) StrategyEnum(strategyEnum []StrategyEnum) ApiExplainPatchApiTestSelectionExplainPatchPatchIdPostRequest {
	r.strategyEnum = &strategyEnum
	return r
}

func (r ApiExplainPatchApiTestSelectionExplainPatchPatchIdPostRequest) Execute() (*PatchExplanation, *http.Response, error) {
	return r.ApiService.ExplainPatchApiTestSelectionExplainPatchPatchIdPostExecute(r)
}

/*
ExplainPatchApiTestSelectionExplainPatchPatchIdPost Explain Patch
...
:return: A mapping from {Build variant x task x test} to a
 ...
 @param patchId
 @return ApiExplainPatchApiTestSelectionExplainPatchPatchIdPostRequest
*/
func (a *TestSelectionAPIService) ExplainPatchApiTestSelectionExplainPatchPatchIdPost(ctx context.Context, patchId string) ApiExplainPatchApiTestSelectionExplainPatchPatchIdPostRequest {
	return ApiExplainPatchApiTestSelectionExplainPatchPatchIdPostRequest{
		ApiService: a,
		ctx: ctx,
		patchId: patchId,
...
func (a *TestSelectionAPIService) ExplainPatchApiTestSelectionExplainPatchPatchIdPostExecute(r ApiExplainPatchApiTestSelectionExplainPatchPatchIdPostRequest) (*PatchExplanation, *http.Response, error) {
	var (
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "TestSelectionAPIService.ExplainPatchApiTestSelectionExplainPatchPatchIdPost")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/api/test_selection/explain_patch/{patch_id}/"
