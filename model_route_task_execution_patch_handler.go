...
// checks if the RouteTaskExecutionPatchHandler type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &RouteTaskExecutionPatchHandler{}

// RouteTaskExecutionPatchHandler struct for RouteTaskExecutionPatchHandler
type RouteTaskExecutionPatchHandler struct {
...
func NewRouteTaskExecutionPatchHandler() *RouteTaskExecutionPatchHandler {
	this := RouteTaskExecutionPatchHandler{}
	return &this
}
...
func (o RouteTaskExecutionPatchHandler) MarshalJSON() ([]byte, error) {
...
func (o RouteTaskExecutionPatchHandler) ToMap() (map[string]interface{}, error) {
...
type NullableRouteTaskExecutionPatchHandler struct {
	value *RouteTaskExecutionPatchHandler
	isSet bool
}

func (v NullableRouteTaskExecutionPatchHandler) Get() *RouteTaskExecutionPatchHandler {
	return v.value
}

func (v *NullableRouteTaskExecutionPatchHandler) Set(val *RouteTaskExecutionPatchHandler) {
	v.value = val
	v.isSet = true
}

func (v NullableRouteTaskExecutionPatchHandler) IsSet() bool {
	return v.isSet
}

func (v *NullableRouteTaskExecutionPatchHandler) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableRouteTaskExecutionPatchHandler(val *RouteTaskExecutionPatchHandler) *NullableRouteTaskExecutionPatchHandler {
	return &NullableRouteTaskExecutionPatchHandler{value: val, isSet: true}
}

func (v NullableRouteTaskExecutionPatchHandler) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableRouteTaskExecutionPatchHandler) UnmarshalJSON(src []byte) error {
	v.isSet = true
